const CheckMarkOutlineIcon = ({ fill, background, style, ...props}: { fill?: string, background?: string, style?: any, [key: string]: any }) => {
    return (
        <svg {...props} tabIndex={0} role="button" style={{
            ...
            ...(style ?? {})
        }} viewBox="0 0 512 512" fill={background ?? '#F3BE3D'}>
            <g>
